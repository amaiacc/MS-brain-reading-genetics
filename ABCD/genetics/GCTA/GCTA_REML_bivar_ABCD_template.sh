...
if [ ! -f ${working_dir}/reml/${phenotype1}_${phenotype2}.hsq ]
then
if [ -f ${working_dir}/${phenotype1}_${phenotype2}.pheno ]
then
echo 'One-grm, quantitative, residuals after adjusting for covariates'
gcta64 --reml-bivar --grm ${working_dir}/grm/${root}  --pheno ${working_dir}/${phenotype1}_${phenotype2}.pheno --reml-bivar-lrt-rg 0 --out ${working_dir}/reml/${phenotype1}_${phenotype2}  > ${working_dir}/reml/logs/${phenotype1}_${phenotype2}'.log'
fi
fi
