...
analysis_dir=/export/home/acarrion/acarrion/projects/${add_dir}${root}/scripts/genetics/PRS/PRSice/
...
Rscript ${analysis_dir}PGS_QC.R ${analysis_dir2}/base_${base_project}.config --verbose
Rscript ${analysis_dir}PGS_lmm.R ${analysis_dir2}/base_${base_project}.config FALSE --verbose

#
Rscript ${analysis_dir2}PGS_${base_project}_viz.R ${analysis_dir2}/base_${base_project}.config