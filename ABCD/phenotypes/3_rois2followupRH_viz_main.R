...
ttables<-ttables[grep("int",ttables,invert=TRUE)] # not TBV corrected
...
ggsave(figure,file=paste(out_dir,pheno,"_",atlas,"_rois2follow_RH",".pdf",sep=""),width=20,height=7)
