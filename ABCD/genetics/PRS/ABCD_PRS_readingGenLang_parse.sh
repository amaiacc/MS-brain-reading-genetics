...
Rscript ${analysis_dir}PGS_lmm.R ${analysis_dir}/../base_${base_project}.config FALSE --verbose

Rscript ${analysis_dir}PGS_${base_project}_viz.R ${analysis_dir}/../base_${base_project}.config --verbose
